...
u_r = 1e-3, // Coeff of rolling friction
sigma = .29, // Poisson ratio for rolling friction.
Y = 2.0e12, // Young's modulus in erg/cm3
cor = 0.4, // Coeff of restitution
simTimeSeconds = 1e-4, // Seconds
timeResolution = 1e-7, // Seconds - This is duration between exported steps. Must be greater than dt
